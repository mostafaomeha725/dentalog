...
class WaitingListViewBody extends StatefulWidget {
  const WaitingListViewBody({super.key,  this.isuser =true});
final bool isuser ;
  @override
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        // Bloc for Specialties
widget. isuser?      BlocConsumer<ShowSpecialtiesCubit, ShowSpecialtiesState>(
        ...
        Text("Waiting List", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
